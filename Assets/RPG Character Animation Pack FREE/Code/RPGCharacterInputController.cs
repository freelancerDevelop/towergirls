...
namespace RPGCharacterAnims{
	...
	public class RPGCharacterInputController : MonoBehaviour{
		...
		void Inputs(){
			...
			inputLightHit = false;//Input.GetButtonDown("Fire1");
			inputDeath = false;//Input.GetButtonDown("Fire2");
			inputAttackL = Input.GetButtonDown("Fire1");
			inputAttackR = Input.GetButtonDown("Fire2");
